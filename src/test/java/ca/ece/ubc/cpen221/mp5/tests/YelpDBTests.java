...
public class YelpDBTests {
	...
	public void test0() throws FileNotFoundException {
		...
		assertEquals(135, aiya.getRestaurantSet().size());
		assertEquals(8556, aiya.getUserSet().size());
		assertEquals(17396, aiya.getReviewSet().size());
		// problem(?): creates Json as JsonArray which I don't like... not actually sure
		// if that'll be an issue later on...
		System.out.println(gson.toJson(aiya.getRestaurantSet()));
	}
